import { r as r$1, e, u as u$2, n as n$1, p as p$1, t, g } from './JSONSupport-9346590f.js';
import { y, m } from './Message-70b34921.js';
import { n, e as e$1 } from './subclass-fe5fcf78.js';
...
See https://js.arcgis.com/4.20/esri/copyright.txt for details.
*/
const a=t$1=>{let a=class extends t$1{constructor(...r$1){super(...r$1);const t=m(e$1(this)),o=t.metadatas,i=t.store,n=new r;t.store=n,i.keys().forEach((r=>{n.set(r,i.get(r),0);})),Object.keys(o).forEach((r=>{t.internalGet(r)&&n.set(r,t.internalGet(r),0);}));}read(r,t){u$2(this,r,t);}getAtOrigin(r,t$1){const s=u$1(this),e=t(t$1);if("string"==typeof r)return s.get(r,e);const o={};return r.forEach((r=>{o[r]=s.get(r,e);})),o}originOf(r){return n$1(this.originIdOf(r))}originIdOf(r){return u$1(this).originOf(r)}revert(r,t$1){const s=u$1(this),e=t(t$1),o=e$1(this);let n;n="string"==typeof r?"*"===r?s.keys(e):[r]:r,n.forEach((r=>{o.invalidate(r),s.revert(r,e),o.commit(r);}));}};return a=e([n("esri.core.ReadOnlyMultiOriginJSONSupport")],a),a};function u$1(r){return e$1(r).store}let f=class extends(a(p$1)){};f=e([n("esri.core.ReadOnlyMultiOriginJSONSupport")],f);

/*
All material copyright ESRI, All Rights Reserved, unless otherwise specified.
See https://js.arcgis.com/4.20/esri/copyright.txt for details.
*/
const p=t$1=>{let s=class extends t$1{constructor(...r){super(...r);}clear(r,t$1="user"){return u(this).delete(r,t(t$1))}write(r={},t){return g(this,r=r||{},t),r}setAtOrigin(r,t$1,s){e$1(this).setAtOrigin(r,t$1,t(s));}removeOrigin(r){const t$1=u(this),s=t(r),o=t$1.keys(s);for(const e of o)t$1.originOf(e)===s&&t$1.set(e,t$1.get(e,s),6);}updateOrigin(r,t$1){const s=u(this),i=t(t$1),c=this.get(r);for(let e=i+1;e<r$1;++e)s.delete(r,e);s.set(r,c,i);}toJSON(r){return this.write({},r)}};return s=e([n("esri.core.WriteableMultiOriginJSONSupport")],s),s.prototype.toJSON.isDefaultToJSON=!0,s};function u(r){return e$1(r).store}const l=t=>{let e$1=class extends(p(a(t))){constructor(...r){super(...r);}};return e$1=e([n("esri.core.MultiOriginJSONSupport")],e$1),e$1};let O=class extends(l(p$1)){};O=e([n("esri.core.MultiOriginJSONSupport")],O);
