import { k as t$6, x as s$3, z as s$4, e as e$7 } from './JSONSupport-9346590f.js';
import { a as u$3 } from './intl-21ab9759.js';
import { T as T$1, d as n$8, n as n$9 } from './Loadable-d16b3d7d.js';
import { u as u$2 } from './Handles-af859b7b.js';
import { n as n$6, y as y$3 } from './Message-70b34921.js';
import { B, j, A as A$1 } from './promiseUtils-2ff2b194.js';
import { o as o$7 } from './uuid-630c0c55.js';
import { d as d$6, j as j$1 } from './watchUtils-06a91cc9.js';
import { A as n$7, a as a$4, y as y$2, n as n$a } from './subclass-fe5fcf78.js';
import { c as c$2 } from './Point-ee7951c3.js';
import { a as a$3 } from './assets-73c8998f.js';
import { g as g$2 } from './locale-b874fc68.js';

/*
All material copyright ESRI, All Rights Reserved, unless otherwise specified.
See https://js.arcgis.com/4.20/esri/copyright.txt for details.
*/
function e$6(e){return "string"==typeof e?document.getElementById(e):e}function t$5(e){for(;e.hasChildNodes();)e.removeChild(e.firstChild);}function o$6(e,t){const n=t.parentNode;n&&n.insertBefore(e,t);}function r$4(e,t){for(;;){const n=e.firstChild;if(!n)break;t.appendChild(n);}}
...
normalizeHex(DEFAULT_COLOR$1.hex());
...
See https://js.arcgis.com/4.20/esri/copyright.txt for details.
*/
let e$3;function m(){commitAssetPath(T$1(a$3(e$3)));}e$3="components/assets";

/*
All material copyright ESRI, All Rights Reserved, unless otherwise specified.
See https://js.arcgis.com/4.20/esri/copyright.txt for details.
*/
const t$2=Symbol("widget"),n$1=new WeakMap;function r(e,t){const n=t.vnodeSelector;if(a(n)){const r=t.properties||{},a=r.key||n;return {vnodeSelector:"div",properties:{parentWidget:e,widgetConstructor:n,key:a,widgetProps:{...r,key:a},afterCreate:o$1,afterUpdate:d,afterRemoved:i},children:void 0,text:void 0,domNode:null}}const c=t.children;if(c)for(let o=0;o<c.length;++o)c[o]=r(e,c[o]);return t}function o$1(t,r,o,{parentWidget:d,widgetConstructor:a,widgetProps:c}){const s=new a({...c,container:t});n$1.set(t,s),null==s.afterCreate||s.afterCreate(s,t),d._internalHandles.add(n$7((()=>i(t))));}function d(e,t,r,{widgetProps:o}){const d=n$1.get(e);d&&(d.set(o),null==d.afterUpdate||d.afterUpdate(d,e));}function i(e){const t=n$1.get(e);t&&(t.destroy(),n$1.delete(e));}function a(e){return "function"==typeof e&&e[t$2]}

/*
All material copyright ESRI, All Rights Reserved, unless otherwise specified.
See https://js.arcgis.com/4.20/esri/copyright.txt for details.
*/
const E="esri.widgets.Widget",L=n$6.getLogger(E);let N=0;const P={widgetIcon:"esri-icon-checkbox-unchecked"};function I(e,t){for(const r in t)null!=e[r]&&("object"==typeof e[r]&&"object"==typeof t[r]?I(e[r],t[r]):e[r]=t[r]);return e}const T=s({postProcessProjectionOptions(e){const t=e.eventHandlerInterceptor,r=/capture$/i;e.eventHandlerInterceptor=(e,o,s,i)=>{const n=t(e,o,s,i),a=r.test(e);if(!((e=e.replace(r,"")).toLowerCase()in s)||a){const t=e[2].toLowerCase()+e.slice(3),r=e=>n.call(s,e);s.addEventListener(t,r,a);const o=()=>s.removeEventListener(t,r,a),l=i.afterRemoved;i.afterRemoved=e=>{null==l||l(e),o();};}return n};},handleInterceptedEvent(e,t,r,o){const{eventPhase:s,type:i}=o,n=s===Event.CAPTURING_PHASE;let a=`on${i}${n?"capture":""}`;const l=t.properties;(a in l||(a=`on${i[0].toUpperCase()}${i.slice(1)}${n?"Capture":""}`,a in l))&&(e.scheduleRender(),l[a].call(l.bind||r,o));}});let U=!1,$=class extends(n$8(n$9.EventedAccessor)){constructor(e,r$1){super(e,r$1),this._attached=!1,this._internalHandles=new u$2,this._projector=T,this.domNode=null,this.iconClass=P.widgetIcon,this.label=this.declaredClass.split(".").pop(),this.visible=!0,this.key=this,this._loadLocale=B((async()=>{if(this._messageBundleProps&&this._messageBundleProps.length){const e=await A$1(this._messageBundleProps.map((async({bundlePath:e,propertyName:t})=>{let r=await u$3(e);this.localeStrings&&Object.keys(this.localeStrings)&&(r=I(y$3(r),this.localeStrings)),this[t]=r;})));for(const t of e)t.error&&L.error("widget-intl:locale-error",this.declaredClass,t.error);}await this.loadLocale();})),m();const o=["light","dark"],n=y$1()||"light";o.includes(n)||s$3(L,"The following themes are deprecated: light-blue, dark-blue, light-green, dark-green, light-purple, dark-purple, light-red, and dark-red.",{version:"4.19",warnOnce:!0,see:"https://developers.arcgis.com/javascript/latest/styling/"});const a$1="esri-widget-uid-"+o$7(),d=this.render.bind(this);let h=!1;this._trackingTarget=new s$4((()=>this.scheduleRender()));const m$1=()=>{var e;if(!h||this.destroyed)return null;if(!this.visible)return {vnodeSelector:"div",properties:{key:a$1,class:"",styles:{display:"none"}},domNode:void 0,children:void 0,text:void 0};const t=d();let{properties:r$1}=t;r$1||(t.properties=r$1={});let{key:o,styles:s}=r$1;o||(r$1.key=a$1),s||(r$1.styles=s={}),s.display||(s.display="");let i=0;return null==(e=t.children)||e.forEach((e=>{if(a(e.vnodeSelector))return;let{properties:t}=e;t||(e.properties=t={}),t.key||(t.key=`${this.id}--${i++}`);})),r(this,t)};this.render=()=>{if(U)return m$1();let e;this._trackingTarget.clear(),U=!0;try{e=a$4(this._trackingTarget,m$1);}finally{U=!1;}return e},this.addResolvingPromise(this._resourcesFetch=this.beforeFirstRender().then((()=>{h=!0,this._postInitialize();})));}normalizeCtorArgs(e,t){const r={...e};return t&&(r.container=t),r}postInitialize(){}beforeFirstRender(){return this._loadLocale().catch(j)}async loadLocale(){}destroy(){this.destroyed||(this._trackingTarget.destroy(),this._trackingTarget=null,this.viewModel&&(this.viewModel.destroy(),this.viewModel=null),this._detach(this.container),this._set("container",null),this._internalHandles.destroy(),this._emitter.clear(),this.render=()=>null,this._projector=null);}set container(e){this._get("container")||this._set("container",e);}castContainer(e){return e$6(e)}get id(){return this._get("id")||this.get("container.id")||Date.now().toString(16)+"-widget-"+N++}set id(e){e&&this._set("id",e);}get renderable(){return this._resourcesFetch}get test(){return {projector:this._projector,handles:this._internalHandles}}render(){throw new Error("not implemented")}scheduleRender(){this.destroyed||this._projector.scheduleRender();}classes(...e){return l$1.apply(this,e)}own(e){arguments.length>1&&(e=Array.prototype.slice.call(arguments)),this._internalHandles.add(e);}renderNow(){this._projector.renderNow();}_postInitialize(){var e;if(this.destroyed)return;this.scheduleRender(),null!=(e=this._delegatedEventNames)&&e.length&&this._internalHandles.add(d$6(this,"viewModel",((e,t)=>{t&&this._internalHandles.remove("delegated-events"),e&&this._internalHandles.add(this._delegatedEventNames.map((t=>e.on(t,(e=>{this.emit(t,e);})))),"delegated-events");}))),this.postInitialize();const t=async()=>{await this._loadLocale().catch(j),this.scheduleRender();};this._internalHandles.add([g$2(t),this.watch("localeStrings",t),j$1(this,"container",(async e=>{this.destroyed||this._attach(e);}))]);}_attach(e){e&&(this._projector.merge(e,this.render),this._attached=!0);}_detach(e){e&&this._attached&&(this._projector.detach(this.render),e.parentNode&&e.parentNode.removeChild(e),this._attached=!1);}};$[t$2]=!0,e$7([y$2({value:null})],$.prototype,"container",null),e$7([c$2("container")],$.prototype,"castContainer",null),e$7([y$2({aliasOf:"container"})],$.prototype,"domNode",void 0),e$7([y$2()],$.prototype,"iconClass",void 0),e$7([y$2()],$.prototype,"id",null),e$7([y$2()],$.prototype,"label",void 0),e$7([y$2()],$.prototype,"localeStrings",void 0),e$7([y$2()],$.prototype,"renderable",null),e$7([y$2()],$.prototype,"viewModel",void 0),e$7([y$2()],$.prototype,"visible",void 0),e$7([y$2()],$.prototype,"key",void 0),e$7([y$2()],$.prototype,"afterCreate",void 0),e$7([y$2()],$.prototype,"afterUpdate",void 0),e$7([y$2()],$.prototype,"afterRemoved",void 0),$=e$7([n$a(E)],$);var x=$;
...
export { E$1 as E, e as a, b$1 as b, e$6 as c, d$5 as d, e$2 as e, t$5 as f, g$1 as g, i$1 as i, l$1 as l, n, o$6 as o, p$2 as p, r$4 as r, t, u$1 as u, w$1 as w, x };
