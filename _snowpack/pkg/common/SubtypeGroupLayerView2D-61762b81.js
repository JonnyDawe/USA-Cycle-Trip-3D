...
import { y } from './FeatureFilter-04f2a9e6.js';
...
*/
function o(e,r){return !e.visible||0!==e.minScale&&r>e.minScale||0!==e.maxScale&&r<e.maxScale}let l=class extends Z{initialize(){this.handles.add([d(this.view,"viewpoint",(()=>this._update()))]);}_injectOverrides(e){const s=super._injectOverrides(e),t$1=this.view.scale,i=this.layer.sublayers.filter((e=>o(e,t$1))).map((e=>e.subtypeCode));if(!i.length)return s;const l=`NOT ${this.layer.subtypeField} IN (${i.join(",")})`;if(t(s))return new y({where:l});const n=s.clone();return n.where+=` AND ${l}`,n}_setLayersForFeature(e){const r=this.layer.fieldsIndex.get(this.layer.subtypeField),s=e.attributes[r.name],t=this.layer.sublayers.find((e=>e.subtypeCode===s));e.layer=t,e.sourceLayer=this.layer;}_createSchemaConfig(){const e={subtypeField:this.layer.subtypeField,sublayers:Array.from(this.layer.sublayers).map((e=>({featureReduction:null,geometryType:this.layer.geometryType,labelingInfo:e.labelingInfo,labelsVisible:e.labelsVisible,renderer:e.renderer,subtypeCode:e.subtypeCode})))},r=this.layer.sublayers.map((e=>e.subtypeCode)).join(","),s=this.layer.sublayers.length?`${this.layer.subtypeField} IN (${r})`:"1=2";let t=this.layer.definitionExpression?this.layer.definitionExpression+" AND ":"";return t+=s,{...super._createSchemaConfig(),...e,definitionExpression:t}}};l=e([n$1("esri.views.2d.layers.SubtypeGroupLayerView2D")],l);var n=l;
