...
import './rasterProjectionHelper-d073bfab.js';
...
*/
let y=class extends(p(p$1(n(p$2(d))))){constructor(){super(...arguments),this.type="imagery-tile-3d",this.isAlignedMapTile=!0;}initialize(){this.layer.increaseRasterJobHandlerUsage();const e=this.updateFullExtent();this.addResolvingPromise(e);const r=x(this.view,"basemapTerrain.tilingSchemeLocked").then((()=>{const e=this.view.basemapTerrain.tilingScheme,{tileInfo:r}=this.layer,t=["png","png24","png32","jpg","mixed"].indexOf(r.format)>-1&&e.compatibleWith(r);this.isAlignedMapTile=t;const i=t?r:e.toTileInfo();this._set("tileInfo",i),this.updatingHandles.add(this,"layer.renderer",(()=>this.refresh())),this.updatingHandles.add(this,"layer.interpolation",(()=>this.refresh())),this.updatingHandles.add(this,"layer.bandIds",(()=>this.refresh())),this.updatingHandles.add(this,"layer.multidimensionalDefinition",(()=>this.refresh()));}));this.addResolvingPromise(r);}destroy(){this.layer.decreaseRasterJobHandlerUsage(),this.view=null;}get _blankTile(){const e=document.createElement("canvas"),r=e.getContext("2d"),[t,i]=this.tileInfo.size;return e.width=t,e.height=i,r.clearRect(0,0,t,i),r.getImageData(0,0,t,i)}get imageFormatIsOpaque(){return "jpg"===this.layer.tileInfo.format}get hasMixedImageFormats(){return "mixed"===this.layer.tileInfo.format}get dataLevelRange(){const e=this.tileInfo.lods,r=this.layer.tileInfo.lods,t=e[0].scale,i=r[r.length-1].scale;return this.levelRangeFromScaleRange(t,i)}async fetchTile(e$1,t,i,s){const a=this.tileInfo,l=this._canSymbolizeInWebGL(),n={tileInfo:a,requestRawData:l,signal:e(s.signal),requestAsImageElement:this.isAlignedMapTile},m=await this.layer.fetchTile(e$1,t,i,n);if(m instanceof HTMLImageElement)return m;let d=m&&m.pixelBlock;if(!d)return this._blankTile;if(!l&&(d=await this.layer.applyRenderer(m),null==d))return this._blankTile;const h=new d$1([e$1,t,i],d,a.size[0],a.size[1]);return l?(h.symbolizerRenderer=this.layer.symbolizer.rendererJSON,h.symbolizerParameters=this.layer.symbolizer.generateWebGLParameters(this._getSymbolizerOptions(e$1)),h.transformGrid=m.transformGrid):h.isRendereredSource=!0,h.interpolation=this.layer.interpolation,h.bandIds=this.layer.bandIds,h}_getSymbolizerOptions(e){const r=this.tileInfo.lodAt(e).resolution;return {pixelBlock:null,isGCS:this.view.spatialReference.isGeographic,resolution:{x:r,y:r},bandIds:this.layer.bandIds}}ensureSymbolizerParameters(e){this._canSymbolizeInWebGL()&&JSON.stringify(e.symbolizerRenderer)!==JSON.stringify(this.layer.symbolizer.rendererJSON)&&(e.symbolizerParameters=this.layer.symbolizer.generateWebGLParameters(this._getSymbolizerOptions(e.lij[0])));}createFetchPopupFeaturesQueryGeometry(e,r){return a(e,r,this.view)}refresh(){this.emit("data-changed");}async doRefresh(e){this.suspended||this.emit("data-changed");}_canSymbolizeInWebGL(){return r().supportsTextureFloat&&this.layer.symbolizer.canRenderInWebGL}};e$1([y$1({readOnly:!0})],y.prototype,"_blankTile",null),e$1([y$1({readOnly:!0})],y.prototype,"imageFormatIsOpaque",null),e$1([y$1({readOnly:!0})],y.prototype,"hasMixedImageFormats",null),e$1([y$1({readOnly:!0})],y.prototype,"dataLevelRange",null),y=e$1([n$1("esri.views.3d.layers.ImageryTileLayerView3D")],y);var c=y;
